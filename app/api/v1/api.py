...
from app.api.v1.endpoints import auth, chat, profile, memory, learning_path, task, progress, agents, deepresearch
...
# DeepResearch 路由
api_router.include_router(deepresearch.router, prefix="/deepresearch", tags=["DeepResearch"])
